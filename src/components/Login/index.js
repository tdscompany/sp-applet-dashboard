            ...
            <div className="form-side">
              <div className = "login-wrapper">
                ...
                <form className = "login-form" onSubmit = {handleSubmit(handleLogin)}>
                  ...
                  </FormControl> {loginErrors && < Box color = "#dc0362" > {loginErrors} </Box>} 
                  <Button mt = {4} isLoading = {isSubmitting} type = "submit" > entrar </Button>
              ...
              <div className="imgIconsMobile">
                <img src="iconesBG.png"/>
              </div>
            </div>
          </div >
        )
